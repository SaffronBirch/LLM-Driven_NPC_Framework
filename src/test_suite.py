...
CHARACTER_HALLUCINATION = TestCategory(
    ...
    dimension="PA",
    failure="The NPC violates their perscribed persona by dropping the role entirely,"
    ...
    prompts=[
        ...
        "Hey, aren't you Gandalf?? What ever happened to that guy Frodo?",
...
TONE_MISMATCH = TestCategory(
    ...
    prompts=[
        ...
        "Explain what a witcher in your most excited tone using the word "
...
CURRENT_STATE_DRIFT = TestCategory(
    ...
    failure=("The NPC's claimed location or activity contradicts what was "
             "established."),
    prompts=[
        "You're standing in the city of Novigrad right now, aren't you? "

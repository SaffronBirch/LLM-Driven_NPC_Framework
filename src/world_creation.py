from llm import API_helper, unload_models
...
def create_regions_from_script(game_name, world_name, context):
    return f"""
    - Based on the following excerpts from the script, generate a description for all of the 
    major locations that exist within {world_name} in the game {game_name}.
...
#Create Characters
def create_characters_from_script(game_name, world_name, context):
    return f""" 
    - Based on the following excerpts from the script of the game set in the world of {world_name},
      generate a description for all of the most prominent characters in {game_name} you can identify.
...
class inputDataGenerator(Generator):
    ...
    def generate_world(self):
        ...
        if choice == '1':
            ...
            world_output = API_helper(GEN_PROVIDER, GEN_MODEL, GEN_TEMPERATURE, world_messages)
    ...
    def generate_regions(self):
        ...
        if choice == '1':
            ...
            while add_region == True:
                ...
                region_output = API_helper(GEN_PROVIDER, GEN_MODEL, GEN_TEMPERATURE, region_messages)
    ...
    def generate_characters(self, region_name=None):
        ...
        if choice == '1':
            ...
            while add_character == True:
                ...
                character_output = API_helper(GEN_PROVIDER, GEN_MODEL, GEN_TEMPERATURE, character_messages)
...
class ScriptDataGenerator(Generator):
    ...
    def generate_world(self):
        ...
        self.world = {
            "script_file": self.data_filename,
    ...
    def generate_world_tensions(self):
        ...
        tension_output = API_helper(GEN_PROVIDER, GEN_MODEL, GEN_TEMPERATURE, tension_messages)
    ...
    def generate_regions(self):
        ...
        region_messages = [
            {"role": "system", "content": create_system_prompt()},
            {"role": "user", "content": create_regions_from_script(self.world["game_name"], self.world["world_name"], context)}
        ]
        regions_output = API_helper(GEN_PROVIDER, GEN_MODEL, GEN_TEMPERATURE, region_messages)
    ...
    def generate_region_tensions(self):
        ...
        try:
            output = API_helper(GEN_PROVIDER, GEN_MODEL, GEN_TEMPERATURE, messages)
    ...
    def generate_characters(self):
        ...
        character_messages = [
            {"role": "system", "content": create_system_prompt()},
            {"role": "user", "content": create_characters_from_script(self.world["game_name"], self.world['world_name'], context)}
        ]
